...
class LightColor {
  ...
  static const Color titleTextColor = const Color(0xff45f3ff);
  static const Color subTitleTextColor = const Color(0xff45f3ff);
  ...
  static const Color iconColor = Color(0xff45f3ff);
  static const Color yellowColor = Color(0xfffbba01);

  static const Color black = Color(0xff20262C);
  static const Color lightblack = Color(0xff5F5F60);

  static const Color teal = Color(0xff45f3ff);
}